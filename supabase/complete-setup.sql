-- =====================================================
-- آواهنگ - راه‌اندازی کامل (کپی و اجرا در SQL Editor)
-- =====================================================
...
-- پایان
-- =====================================================
SELECT '✅ آواهنگ با موفقیت راه‌اندازی شد!' as message;